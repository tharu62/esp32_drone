/* Simple Firmware for ESP32 DRONE CONTROLLER
...
void app_main(void)
{
    ...
    while (true) {
        ...
        if ((t_end - t_start) >= dt) {
            ...
            #endif
            #ifdef BMI088_H
            // bmi088_update(&drone_state, dt_sec);
            #endif
    ...
    // SETTING OFF ALL DEVICES PROPERLY
    // motor_off();
    #ifdef MPU6050_H
