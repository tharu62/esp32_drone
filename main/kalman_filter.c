...
#define STANDARD_DEV_ACCEL_NOISE_SQRD 4.0f // Standard deviation squared of acceleration noise (deg) 
#define STANDARD_DEV_GYRO_NOISE_SQRD 2.0f  // Standard deviation squared of gyro 
...
void kalman_filter(State *drone_state, float dt) { 
    ...
    // Update angle by combining angle from accelerometer measurement and integrated gyro angle with Kalman gain on complementary filter logic 
